...
func (tool *grepTool) Definition() modelcall.ToolDefinition {
...
func (tool *globTool) Definition() modelcall.ToolDefinition {
	return modelcall.ToolDefinition{
		Name:        "glob",
		Destructive: false,
...
func (tool *listTool) Definition() modelcall.ToolDefinition {
	return modelcall.ToolDefinition{
		Name:        "ls",
		Destructive: false,
