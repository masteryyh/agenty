...
func objectSchema(
	...
	required []string,
) modelcall.JSONSchema {
	return modelcall.JSONSchema{
...
func stringSchema(description string) modelcall.JSONSchema {
	return modelcall.JSONSchema{
...
func integerSchema(description string, minimum float64) modelcall.JSONSchema {
	return modelcall.JSONSchema{
...
func booleanSchema(description string) modelcall.JSONSchema {
	return modelcall.JSONSchema{
		Type:        modelcall.JSONSchemaTypeBoolean,
		Description: description,
	}
}
