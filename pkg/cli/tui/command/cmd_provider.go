...
func handleProviderCmd(b backend.Backend, bridge Bridge, args []string, sessionID uuid.UUID, modelID uuid.UUID, agentID uuid.UUID, state *ChatState) (CommandResult, error) {
	for {
...
func doCreateProvider(b backend.Backend, bridge Bridge) error {
