...
func handleSkillCmd(b backend.Backend, bridge *UIBridge, args []string, sessionID uuid.UUID, modelID uuid.UUID, agentID uuid.UUID, state *ChatState) (CommandResult, error) {
	for {
...
func showSkillContent(b backend.Backend, bridge *UIBridge, skill models.SkillDto, sessionID uuid.UUID) error {
